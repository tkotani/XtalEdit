...
ffi_srcdir = '/home/takao/XtalEdit/Python-2.5.4/Modules/_ctypes/libffi'
ffi_sources += ffi_platforms['X86_64']
ffi_sources = [os.path.join('/home/takao/XtalEdit/Python-2.5.4/Modules/_ctypes/libffi', f) for f in ffi_sources]
