      ...
      bitand=0
      if(i1==1.and.i2==1) bitand=1
      end
      subroutine cexit(ix,iy)
      print *, ' cexit: return code=',ix
      stop ' cexit: '
      end
      subroutine getsvv(nam,ival,iopt,i1,i2,vec)
      character*(*) nam
      double precision vec(1)
      ival=0
c      stop 'getsvv is not defined. See symvec.f'
      end
...
C Local parameters
      ...
      subroutine nlchar(ixx,s)
      character*(*) s
      s(1:1)=char(10) !ascii LF
      end

!--------------------------------------------------------------------------
!  d1mach,f from http://www.netlib.org/blas/d1mach.f 
!-------------------------------------------------------------------------
