      SUBROUTINE Z1BTRF( M, N, KL, KU, AB, LDAB, IPIV, IPIVC, INFO )
*
...
*  =======
*
*  Z1BTRF is a variant of ZGBTRF, which additionally constrains pivots
...
*     ..
*     .. Local Scalars ..
      INTEGER            I, I2, I3, IC, II, IP, J, J2, J3, JB, JJ, JM,
...
*        Use unblocked code
*
         CALL Z1BTF2( M, N, KL, KU, AB, LDAB, IPIV, IPIVC, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               JP = IZAMAX( MIN(KM,IPIVC(IC)-JJ)+1, AB( KV+1, JJ ), 1 )
               IPIV( JJ ) = JP + JJ - J
